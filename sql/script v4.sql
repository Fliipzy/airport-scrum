...
CREATE TABLE IF NOT EXISTS `lufthavn`.`afgang` (
  `idAfgang` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lufthavn`.`flyselskab` (
  `idFlySelskab` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lufthavn`.`flysize` (
  `idFlySize` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lufthavn`.`Standplads` (
  `standpladsNummer` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `lufthavn`.`fly` (
  `idFly` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `lufthavn`.`serviceSelskab`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `lufthavn`.`serviceSelskab` (
  `idHandlingSelskab` INT(11) NOT NULL AUTO_INCREMENT,
  `size` VARCHAR(45) NOT NULL,
